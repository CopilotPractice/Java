...
}else if(rememberIdPw !=null && rememberIdPw.equals("keepId")){
	cookieRememberIdPw = new Cookie("rememberIdPw", "keepId");	
	cookieId = new Cookie("id", id);
	cookiePw = new Cookie("pw", pw);
	cookieId.setMaxAge(60*5);
...
response.sendRedirect("http://localhost:8081/Chap08/CookieHardChk.jsp");
%>
</body>
</html>