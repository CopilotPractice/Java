...
%>
	<h3>[<%=id%>]님 환영합니다<br/></h3>
	로그인 아이디/비밀번호 기억상태를 [
	<% if(rememberIdPw.equals("temp")){
		out.print("유지하지 않음");
		}else if(rememberIdPw.equals("keep")){
			out.print("아이디/비밀번호 유지함");
		}else{
			out.print("아이디 유지함");
		}
	%>]으로 설정하셨습니다.
	
	<form action="CookieHardLogout.jsp" method="post">
...
%>
	...
	로그인하여 주시기 바랍니다</h3>
	<form action="CookieHardLogin.jsp" method="post">
